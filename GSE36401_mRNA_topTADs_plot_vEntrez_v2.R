...
# Rscript GSE36401_mRNA_topTADs_plot_vEntrez_v2.R
...
outFold <- file.path(setDir, "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2_TopDom//GSE36401_mRNA_TOPTADs_BOXPLOT_vEntrez_v2", curr_dataset)
