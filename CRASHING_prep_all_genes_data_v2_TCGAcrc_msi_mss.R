startTime <- Sys.time()
cat(paste0("> Rscript prep_all_genes_data_v2_TCGAcrc_msi_mss.R\n"))
...
outFold <- file.path(setDir, paste0("/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2_", caller), "PREP_ALL_GENES_v2_TCGAcrc_msi_mss")
