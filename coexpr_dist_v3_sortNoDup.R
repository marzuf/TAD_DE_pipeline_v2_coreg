startTime <- Sys.time()
cat(paste0("> Rscript coexpr_dist_v3_sortNoDup.R\n"))
...
# top-ranking:
# Rscript coexpr_dist_v3_sortNoDup.R TCGAcrc_msi_mss hgnc # running
# Rscript coexpr_dist_v3_sortNoDup.R GSE102073_stic_nostic hgnc # running
# Rscript coexpr_dist_v3_sortNoDup.R GSE65540_before_after hgnc # running
# Rscript coexpr_dist_v3_sortNoDup.R GSE74927_neg_pos hgnc
# Rscript coexpr_dist_v3_sortNoDup.R GSE84231_lhb_rhb hgnc
# Rscript coexpr_dist_v3_sortNoDup.R GSE86356_tibMD1_tibNorm hgnc
# Rscript coexpr_dist_v3_sortNoDup.R TCGAbrca_lum_bas hgnc 
# Rscript coexpr_dist_v3_sortNoDup.R TCGAstad_msi_gs hgnc 
# Rscript coexpr_dist_v3_sortNoDup.R TCGAacc_acc_mutCTNNB1 hgnc 
# Rscript coexpr_dist_v3_sortNoDup.R GSE86422_myoPre_myoPost hgnc 
# Rscript coexpr_dist_v3_sortNoDup.R GSE79209_dysp_nodysp hgnc 
# Rscript coexpr_dist_v3_sortNoDup.R TCGAstad_EBVneg_EBVpos hgnc 

# Rscript coexpr_dist_v3_sortNoDup.R <dataset> <family>
...
outFold <- file.path(setDir, paste0("/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2_", caller), "COEXPR_DIST_v3_SORTNODUP",  paste0(curr_dataset,  "_", familyData))
