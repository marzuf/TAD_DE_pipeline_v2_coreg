startTime <- Sys.time()
cat(paste0("> Rscript AUC_coexprDist.R\n"))
...
outFold <- file.path(setDir, paste0("/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2_", caller), "AUC_COEXPRDIST",  paste0(curr_dataset))
