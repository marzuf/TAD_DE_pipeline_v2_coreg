...
outFold <- file.path(setDir, paste0("/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2_", caller), "CHECK_COEXPR_DIST")
...
datasets_coexpr_summary_DT <- datasets_coexpr_summary_DT[order(datasets_coexpr_summary_DT$coexpr_mean, decreasing=TRUE),]
...
all_ref_var <- c("coexpr_mean", "coexpr_median")
all_curr_var <- c("nAllSamp", "nGenePairs",  "meanMostVar")
